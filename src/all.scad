...
// RENDER svg
module bars_a5_4() {
    bars(lihit_a5(4), "1.5x 4.0");
};

// RENDER svg
module bars_a5_4mm_back() {
    bars(mirror_paper(lihit_a5(4)), "4.0 1.5x");
};
...
module bars_a5_3o5mm() {
    bars(lihit_a5(3.5), "1.5x 3.5");
};

// RENDER svg
module bars_a5_3o5mm_back() {
    bars(mirror_paper(lihit_a5(3.5)), "3.5 1.5x");
};
...
// RENDER svg
module bars_a5_3mm() {
    bars(lihit_a5(3), "1.5x 3.0");
};

// RENDER svg
module bars_a5_3mm_back() {
    bars(mirror_paper(lihit_a5(3)), "3.0 1.5x");
};
